              ...
              return (
                ...
                >
                  ...
                  <div className="aspect-square relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/20 opacity-0 group-hover:opacity-80 group-focus:opacity-80 transition-opacity duration-300" />
                    
                    {/* Category badge - visible on hover only */}
                    <div className="absolute top-4 left-4 z-10 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-300">
      ...
      {selectedImage && selectedImageData && (
        ...
        >
          <div className="relative w-full h-full max-w-7xl mx-auto flex items-center">
            ...
            <div 
              className="w-full h-full max-h-[90vh] bg-white rounded-2xl overflow-hidden shadow-2xl flex"
