...
const Programs: React.FC = () => {
  ...
  // Comprehensive program data with all required information
            ...
            <div className="bg-teal-700 rounded-3xl p-8 md:p-12 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  ...
                  className="bg-white text-teal-700 px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105 transform"
